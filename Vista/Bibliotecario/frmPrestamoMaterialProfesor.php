...
<head>
    ...
    <link rel="stylesheet" href="../../Css/VistaBibliotecario/prestamos/buscarProfesorPrestamoMaterial.css">
...
<body>
    <form action="../../Control/controladorPrestamoMaterial.php" method="post" class="form-register-creador">
        ...
        <h2 class="tittle-creacuenta">PRESTAMO MATERIAL DIDACTICO PROFESOR</h2>
        <div class="container-input-register">

            <label for="identProfesor" id="identProfesor" ></label>  
            <input type="text" name="identProfesor" id="BuscarPorProfesor" placeholder="Buscar Profesor..." autocomplete="off" class="input-100" onkeyup="validarBuscarE(event)">
...
if (@$x == 2) {
    echo '<div class="overlay-container">
		...
		<div class="window-container zoomout">
			<h3>Mensaje ChampaLibrary </h3> 
			Problemas al registrar prestamo<br>
