...
include '../../Recursos/Paginacion/Paginador/PaginadorPrestamoM.php';
...
$libros = $objGestionLibro->listarPrestamoMaterial($inicio, $registros);
...
$cbk = function($row) {
    ...
    $html .= "
            ...
            <tr>
                ...
                <td class='text-left'>{$row->preFechaMaterial}</td>
