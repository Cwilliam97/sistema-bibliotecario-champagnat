...
<head>
    ...
    <link rel="stylesheet" href="../../Css/VistaBibliotecario/prestamos/buscarAdministrativoPrestamoMaterial.css">
    ...
    <script type="text/javascript" src="Javascript/ValidacionFecha.js"></script>
</head>

<body>
    <form action="../../Control/controladorPrestamoMaterial.php" method="post" class="form-register-creador">

        <h2 class="tittle-creacuenta">PRESTAMO MATERIAL DIDIACTICO ADMINISTRATIVOS</h2>
        <div class="container-input-register">
            ...
            <input type="date" name="fechaPrestamo" class="input-48" id="datepicker" onkeypress="" style="height: 50px;">
