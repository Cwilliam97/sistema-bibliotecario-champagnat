...
include '../../Recursos/Paginacion/Paginador/PaginadorProfesor.php';
...
$profesores = $objGestionProfesor->listarProfesor($inicio, $registros);

$paginador->setCabeceraTable(
        '
            <br><br><br>
            <link rel="stylesheet" href="../../Css/VistaAdministrador/tabla.css">
            <h3 style="text-align: center; color: #0F97BD; font-size: 27px; margin-top: 30px; margin-bottom: 30px;">LISTADO PROFESORES</h3>
...
$cbk = function($row) {
    ...
    $html .= "
            ...
            <tr>
                ...
                <td align='center' class='text-left'><a href='index.php?pag=frmActualizarProfesor&id={$row->perIdentificacion}'>
...
echo $paginador->contenido($profesores->data->rows, $profesores->data->count, $cbk);
?>
...
if (@$x == 1) {
    echo '<div class="overlay-container">
		...
		<div class="window-container zoomout">
			...
			Profesor Actualizado Correctamente<br/>
			<br/>
                        <br>
...
if (@$x == 2) {
    echo '<div class="overlay-container">
		...
		<div class="window-container zoomout">
			<h3>Mensaje ChampaLibrary </h3> 
			Problemas al intentar actualizar Profesor<br/>
			<br/>
                        <br>
			<span class="close">Cerrar</span>
		</div>
