...
<head>
    ...
    <link rel="stylesheet" href="../../Css/VistaBibliotecario/prestamos/buscarProfesorPrestamoLibro.css">
    <link rel="stylesheet" href="../../Css/VistaBibliotecario/prestamos/buscarLibroPrestamoProfesor.css">
    <link rel="stylesheet" href="ventanaEmergente/ventanaRespuestaPrestamoLibroP.css">
    <script type="text/javascript" src="Javascript/jquery-1.7.1.min.js"></script>
    <script type="text/javascript" src="Javascript/busquedaProfesor.js"></script>
    <script type="text/javascript" src="Javascript/busquedaLibro.js"></script>
    <script type="text/javascript" src="Javascript/validacionCamposPrestamoLibroProfesor.js"></script>
</head>

<body>
    <form action="../../Control/controladorPrestamoLibro.php" method="post" class="form-register-creador">

        <h2 class="tittle-creacuenta">PRESTAMO LIBRO PROFESOR</h2>
        <div class="container-input-register">

            <label for="identProfesor" id="identProfesor" ></label>  
            <input type="text" name="identProfesor" id="BuscarPorProfesor" placeholder="Buscar Profesor..." autocomplete="off" class="input-100" onkeyup="validarBuscarP(event)">
            <input type="hidden" name="identificacion" id="inputOcultoIdProfesor">
            <div id="listadoIdenAgregarP"></div>
