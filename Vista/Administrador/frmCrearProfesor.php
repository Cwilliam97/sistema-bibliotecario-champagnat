...
<link rel="stylesheet" href="ventanaEmergente/ventanaRespuestaProfesor.css">
<script type="text/javascript" src="Javascript/jquery-1.7.1.min.js"></script>


<form action="../../Control/controladorProfesor.php" method="post" class="form-register-creador">

    <h2 class="tittle-creacuenta">CREAR PROFESOR</h2>
...
if (@$x == 1) {
    echo '<div class="overlay-container">
		...
		<div class="window-container zoomout">
			...
			Profesor Agregado Correctamente<br/>
			<br/>
                        <br>
