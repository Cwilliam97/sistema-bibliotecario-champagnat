...
//            $("#codigo").focus().after('<span class="error2">Identificacion Invalida</span>');
//            return false;
//        }

//        if ($("#nombre").val().length < 10) {
//            $("#nombre").focus().after('<span class="error2">Titulo Invalido</span>');
//            return false;
//        }

        if ($("#nombre").val() === "") {
            $("#nombre").focus().after('<span class="error2">Ingrese un titulo</span>');
            return false;
        }
        ...
        if ($("#autor").val() === "") {
            $("#autor").focus().after('<span class="error2">Ingrese un Autor</span>');
            return false;
        }

//        if ($("#autor").val().length>10) {
//            $("#autor").focus().after('<span class="error2">Autor Invalido</span>');
//            return false;
//        }
//        if ($("#autor").val().length < 40) {
//            $("#autor").focus().after('<span class="error2">Autor Invalido</span>');
//            return false;
//        }
//        if ($("#autor").val().length < 2) {
//            $("#autor").focus().after('<span class="error2">Autor Invalido</span>');
//            return false;
//        }
...
//        }
        ...
        if ($("#editorial").val() === "") {
            $("#editorial").focus().after('<span class="error2">Ingrese una editorial</span>');
            return false;
        }

        if ($("#editorial").val().length > 40) {
            $("#editorial").focus().after('<span class="error2">Editorial Invalida</span>');
            return false;
        }
        if ($("#editorial").val().length < 5) {
            $("#editorial").focus().after('<span class="error2">Editorial Invalida</span>');
            return false;
        }

        if ($("#estado").val() === "") {
            $("#estado").focus().after('<span class="error2">Ingrese un estado</span>');
            return false;
        }
...
//        }
//
//        if ($("#usuario").val().length > 20) {
//            $("#usuario").focus().after('<span class="error2">Usuario Invalido</span>');
//            return false;
//        }
...
//            $("#password").focus().after('<span class="error2">Contrase&ntildea Invalida</span>');
//            return false;
//        }
...
//            return true;
//        else {
//            $("#password2").focus().after('<span class="error2">Las Contrase&ntildeas no Coinciden</span>');
//            return false;
//        }
